...
<CTA
  layout="stack"
  title="Continue with agents"
  description="What sits behind `search`, and how an agent finds any of this without being told the URLs."
>
  <Fragment slot="actions">
    <Button href="/agents/retrieval">Retrieval</Button>
    <Button href="/agents/discovery" variant="secondary">Discoverability</Button>
  </Fragment>
</CTA>
