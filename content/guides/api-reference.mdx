...
<Callout title="See it working first" tone="tip">
...
<Steps>
  ...
  <Step title="Name the tab in seo.apiReferenceTabs">
    ...
    contents, because a showcase that *illustrates* an endpoint is not an API
...
<ParamField body="rateLimit" type="object" required>
  ...
  <Expandable title="properties">
    <ParamField body="search" type="integer" default="30">
      Retrieval calls. These are the expensive ones.
    </ParamField>
    <ParamField body="read" type="integer" default="90">
...
<CTA
  layout="stack"
  title="Ship the reference"
  description="Endpoint pages, the spec you generated them from, and the Markdown twin of each one all deploy together, on Cloudflare, or on any static host."
