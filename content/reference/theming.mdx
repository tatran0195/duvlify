...
against the accent *tints* used behind badges, method pills, and changelog
...
<Callout title="Measure both, not just the background" tone="warning">
...
<Callout title="Why that is written down" tone="note">
...
<Callout title="A self-hosted font is a redistributed font" tone="warning">
